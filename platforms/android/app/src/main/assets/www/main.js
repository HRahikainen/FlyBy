...
/* harmony import */ var _app_fcm_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../app/fcm.service */ "./src/app/fcm.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"],
            ...
            _app_fcm_service__WEBPACK_IMPORTED_MODULE_4__["FcmService"],
...
/* harmony import */ var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/firebase/ngx */ "./node_modules/@ionic-native/firebase/ngx/index.js");
/* harmony import */ var _fcm_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./fcm.service */ "./src/app/fcm.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                angularfire2__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(config),
                angularfire2_firestore__WEBPACK_IMPORTED_MODULE_10__["AngularFirestoreModule"]
            ],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_11__["Firebase"],
                ...
                _fcm_service__WEBPACK_IMPORTED_MODULE_12__["FcmService"],
...
/*!********************************!*\
  !*** ./src/app/fcm.service.ts ***!
  \********************************/
/*! exports provided: FcmService, Element */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _src_app_home_home_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../src/app/home/home.page */ "./src/app/home/home.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FcmService = /** @class */ (function () {
    function FcmService(firebase, afs, platform, hmp) {
    ...
    FcmService.prototype.saveToken = function (token) {
        if (!token)
            return;
        var devicesRef = this.afs.collection(token);
        var data = {
            token: token,
            userId: 'testUserId'
        };
    ...
    FcmService = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_1__["Firebase"],
            angularfire2_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            _src_app_home_home_page__WEBPACK_IMPORTED_MODULE_4__["HomePage"]])
    ], FcmService);
    return FcmService;
}());
...
module.exports = "<ion-content padding >\n    <ion-grid>\n        <ion-row>\n          <ion-col col-2 align-self-start style=\"text-align: left\">\n              <img src=\"../../assets/img/face.png\" class=\"lft\" />\n\n          </ion-col >\n          <ion-col col-8 align-self-center style=\"text-align: center\">\n              <img src=\"../../assets/img/lg.png\" class=\"mid\"/>\n\n          </ion-col >\n          <ion-col col-2 align-self-end style=\"text-align: right\" >\n              <img src=\"../../assets/img/burg.png\" class=\"rght\" />\n\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n\n      \n      <div class=\"container\">\n\n        <img src=\"../../assets/img/balance.png\" />\n\n        <img src=\"../../assets/img/plus.png\" class=\"mid-right\"/>\n\n          <p class=\"centered\" >€{{balance}}</p>\n          <p class=\"centeredblc\" >BALANCE</p>\n\n      </div>\n\n      <p class=\"white\">Today</p>\n\n      <ion-list *ngFor=\"let item of elements\">\n          <ion-item>\n              <ion-avatar slot=\"start\">\n                <img src = {{item.pic}} />\n              </ion-avatar>\n              <ion-label class=\"white\">\n                <h2>{{item.name}}</h2>\n                <h2 style=\"text-align:right\">€{{item.cost}}</h2>\n              </ion-label>\n            </ion-item>\n      </ion-list>\n\n\n</ion-content>\n"
...
module.exports = ".bckg {\n  background-color: black !important; }\n\n.lft {\n  height: 44px;\n  width: auto;\n  text-align: left; }\n\n.mid {\n  height: 35px;\n  width: auto;\n  text-align: center; }\n\n.rght {\n  text-align: right;\n  height: 32px;\n  margin-bottom: 5px; }\n\n.sz {\n  height: 10%;\n  width: auto; }\n\n.balance {\n  position: relative;\n  border: none;\n  box-shadow: none;\n  -moz-box-shadow: none;\n  -o-box-shadow: none;\n  -webkit-box-shadow: none;\n  top: 50%;\n  right: 50%; }\n\n.centered {\n  position: absolute;\n  top: 20%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  font-size: 3rem;\n  color: white;\n  text-shadow: 3px;\n  font-weight: 600; }\n\n.centeredblc {\n  position: absolute;\n  bottom: 20%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  font-size: 0.8rem;\n  color: white;\n  font-weight: 600; }\n\n.mid-right {\n  position: absolute;\n  top: 33%;\n  right: 13%;\n  height: 40px;\n  width: 40px; }\n\n.container {\n  position: relative;\n  text-align: center;\n  color: white; }\n\n.white {\n  color: white; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/*!***********************************!*\
  !*** ./src/app/home/home.page.ts ***!
  \***********************************/
/*! exports provided: HomePage, Element */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.getElements = function () {
        this.elements = [
            {
                name: "X-burger",
                cost: 11.49,
...
module.exports = __webpack_require__(/*! /Users/MantasSkackauskas/Documents/junction/flybyfb/src/main.ts */"./src/main.ts");
